...
//                 </div>
//                 {selectedImage && (<div className=" inset-0 bg-white/0 backdrop-blur-[5px] flex items-center justify-center z-10 fixed shadow-xl " onClick={() => setSelectedImage(null)}>

//                     <div>
//                         <img src={selectedImage} alt="" className=" sticky w-[40vw] max-h-[60vh]  rounded-xl   " />
//                     </div>
